...
$packageArgs = @{
  ...
  url            = 'https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/11.0.6/jetty-home-11.0.6.zip'
  checksum       = 'a7438aa98186a65539e66cc87cfe51557f3c6b89a6b0b3a7f84374336cbb2b88'
  checksumType   = 'sha256'
}
