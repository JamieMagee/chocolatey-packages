...
$packageArgs = @{
  ...
  url            = 'https://repo1.maven.org/maven2/org/eclipse/jetty/jetty-home/11.0.2/jetty-home-11.0.2.zip'
  checksum       = 'edaea1cde6875bc572e1e664a2f9c3e925d4f5273e51e01c8ee1e5e072bdae35'
  checksumType   = 'sha256'
}
